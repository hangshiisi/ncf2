...
def predict_probability(feature_matrix, coefficients):
    ...
    ## YOUR CODE HERE
    predict = np.dot(feature_matrix, coefficients)
    
    # Compute P(y_i = +1 | x_i, w) using the link function
    ## YOUR CODE HERE
    predictions = [ 1.0/(1.0 + np.exp(-x)) for x in predict ]
...
def feature_derivative_with_L2(errors, feature, coefficient, l2_penalty, feature_is_constant): 
    ...
    ## YOUR CODE HERE
    prod = np.dot(errors, feature)

    # add L2 penalty term for any feature that isn't the intercept.
    if not feature_is_constant: 
        ## YOUR CODE HERE
        derivative = prod - 2 * l2_penalty * coefficient 
    else: 
        derivative = prod
...
l2_0_table = table.topk('coefficients [L2=0]', k = 5, reverse=False)
positive_words = l2_0_table['word']
print positive_words

l2_0_table_neg = table.topk('coefficients [L2=0]', k = 5, reverse=True)
negative_words = l2_0_table_neg['word']
