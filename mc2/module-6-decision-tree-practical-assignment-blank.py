...
def intermediate_node_num_mistakes(labels_in_node):
    ...
    ## YOUR CODE HERE
    return num_safe if num_risky > num_safe else num_risky 
...
def best_splitting_feature(data, features, target):
    ...
    #print "length is ", num_data_points 
    
    # Loop through each feature to consider splitting on that feature
    for feature in features:
        
        # The left split will have all data points where the feature value is 0
        left_split = data[data[feature] == -1]
        ...
        ## YOUR CODE HERE
        error1 = (left_mistakes + right_mistakes)/ float(len(data))
        ...
        if error1 < best_error:
            ...
            #print "error1 reduced to  ", error1, feature  
